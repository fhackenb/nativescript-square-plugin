...
declare class NSError extends NSObject implements NSCopying, NSSecureCoding {
	...
	static SCC_APIErrorWithErrorCodeString(errorCodeString: string): NSError;

	static SCC_cannotPerformRequestError(): NSError;

	static SCC_invalidRequestAmountError(): NSError;

	static SCC_invalidRequestCallbackURLError(): NSError;

	static SCC_localizedDescriptionForErrorCodeString(errorCodeString: string): string;

	static SCC_missingCurrencyCodeError(): NSError;

	static SCC_missingOrInvalidResponseDataError(): NSError;

	static SCC_missingOrInvalidResponseErrorCodeError(): NSError;

	static SCC_missingOrInvalidResponseJSONDataError(): NSError;

	static SCC_missingOrInvalidResponseStatusError(): NSError;

	static SCC_missingRequestClientIDError(): NSError;

	static SCC_unableToGenerateRequestJSONError(): NSError;
...
declare class NSURL extends NSObject implements NSCopying, NSItemProviderReading, NSItemProviderWriting, NSSecureCoding, QLPreviewItem {
	...
	SCC_HTTPGETParameters(): NSDictionary<any, any>;
